...
//$.email.value = $.first_name.value = $.last_name.value = $.password.value = $.pass_confirm.value = $.phone.value = $.gender.value= $.country.value= $.b_day.value= $.note.value = "claudio.rodrigues98@mail.com.pt";// Arguments passed into this controller can be accessed via the `$.args` object directly or:
var args = $.args;
